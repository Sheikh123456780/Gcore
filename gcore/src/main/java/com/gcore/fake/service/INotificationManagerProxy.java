...
import com.gcore.fake.frameworks.BNotificationManager;
...
public class INotificationManagerProxy extends BinderInvocationStub {
    ...
    public static class GetNotificationChannels extends MethodHook {
        ...
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            List<NotificationChannel> notificationChannels = BNotificationManager.get().getNotificationChannels(GActivityThread.getAppPackageName());
    ...
    public static class GetNotificationChannelGroups extends MethodHook {
        ...
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            List<NotificationChannelGroup> notificationChannelGroups = BNotificationManager.get().getNotificationChannelGroups(GActivityThread.getAppPackageName());
