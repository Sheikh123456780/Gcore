...
import com.gcore.entity.am.RunningAppProcessInfo;
import com.gcore.entity.am.RunningServiceInfo;
import com.gcore.fake.delegate.ContentProviderDelegate;
import com.gcore.fake.delegate.InnerReceiverDelegate;
import com.gcore.fake.delegate.ServiceConnectionDelegate;
...
import com.gcore.fake.service.context.providers.ContentProviderStub;
import com.gcore.proxy.ProxyManifest;
import com.gcore.proxy.record.ProxyBroadcastRecord;
import com.gcore.proxy.record.ProxyPendingRecord;
...
public class IActivityManagerProxy extends ClassInvocationStub {
    ...
    protected Object getWho() {
        ...
        } else if (BuildCompat.isLollipop()) {
    ...
    public static class GetContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Exception {
            ...
            if (auth instanceof String) {
                ...
                if (BuildCompat.isQ()) {
                    args[1] = GreenBoxCore.getHostPkg();
                }
                if (auth.equals("settings") || auth.equals("media") || auth.equals("telephony")) {
                    ...
                    ProviderInfo providerInfo = GreenBoxCore.getBPackageManager().resolveContentProvider((String) auth, GET_META_DATA, GActivityThread.getUserId());
                    if (providerInfo == null) {
                        return null;
                    }
                    Log.d(TAG, "hook app: " + auth);
                    IBinder providerBinder = null;
                    if (GActivityThread.getAppPid() != -1) {
                        AppConfig appConfig = GreenBoxCore.getBActivityManager().initProcess(providerInfo.packageName, providerInfo.processName, GActivityThread.getUserId());
                        if (appConfig.bpid != GActivityThread.getAppPid()) {
                            providerBinder = GreenBoxCore.getBActivityManager().acquireContentProviderClient(providerInfo);
                        }
                        args[authIndex] = ProxyManifest.getProxyAuthorities(appConfig.bpid);
                        args[getUserIndex()] = GreenBoxCore.getHostUserId();
                    }
                    if (providerBinder == null)
                        return null;
                    content = method.invoke(who, args);
                    Reflector.with(content).field("info").set(providerInfo);
                    Reflector.with(content).field("provider").set(new ContentProviderStub().wrapper(BRContentProviderNative.get().asInterface(providerBinder), GActivityThread.getAppPackageName()));
                }
                return content;
            }
            return method.invoke(who, args);
    ...
    public static class StartService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = GreenBoxCore.getBPackageManager().resolveService(intent, 0, resolvedType, GActivityThread.getUserId());
            if (resolveInfo == null) {
                return method.invoke(who, args);
            }
            ...
            return GreenBoxCore.getBActivityManager().startService(intent, resolvedType, requireForeground, GActivityThread.getUserId());
        }
    ...
    public static class StopService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            Intent intent = (Intent) args[1];
            String resolvedType = (String) args[2];
            return GreenBoxCore.getBActivityManager().stopService(intent, resolvedType, GActivityThread.getUserId());
        }
    }
    ...
    public static class StopServiceToken extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            GreenBoxCore.getBActivityManager().stopServiceToken(componentName, token, GActivityThread.getUserId());
            return true;
        }
    }
    ...
    public static class BindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            userId = userId == -1 ? GActivityThread.getUserId() : userId;
            ResolveInfo resolveInfo = GreenBoxCore.getBPackageManager().resolveService(intent, 0, resolvedType, userId);
            if (resolveInfo != null || AppSystemEnv.isOpenPackage(intent.getComponent())) {
                Intent proxyIntent = GreenBoxCore.getBActivityManager().bindService(intent, connection == null ? null : connection.asBinder(), resolvedType, userId);
                if (connection != null) {
        ...
        protected boolean isEnable() {
            return GreenBoxCore.get().isBlackProcess() || GreenBoxCore.get().isServerProcess();
        }
    }
    ...
    public static class UnbindService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            GreenBoxCore.getBActivityManager().unbindService(iServiceConnection.asBinder(), GActivityThread.getUserId());
    ...
    public static class GetRunningAppProcesses extends MethodHook {
        ...
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            RunningAppProcessInfo runningAppProcesses = BActivityManager.get().getRunningAppProcesses(GActivityThread.getAppPackageName(), GActivityThread.getUserId());
    ...
    public static class GetServices extends MethodHook {
        ...
        @Override
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            RunningServiceInfo runningServices = BActivityManager.get().getRunningServices(GActivityThread.getAppPackageName(), GActivityThread.getUserId());
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            for (int i = 0; i < intents.length; i++) {
                ...
                if (type == ActivityManagerCompat.INTENT_SENDER_ACTIVITY) {
                    ...
                    shadow.setComponent(new ComponentName(GreenBoxCore.getHostPkg(), ProxyManifest.getProxyPendingActivity(GActivityThread.getAppPid())));
                    ProxyPendingRecord.saveStub(shadow, intent, GActivityThread.getUserId());
                    intents[i] = shadow;
                }
            }
            IInterface invoke = (IInterface) method.invoke(who, args);
            if (invoke != null) {
                String[] packagesForUid = BPackageManager.get().getPackagesForUid(GActivityThread.getCallingBUid());
                if (packagesForUid.length < 1) {
                    packagesForUid = new String[]{GreenBoxCore.getHostPkg()};
                }
                GreenBoxCore.getBActivityManager().getIntentSender(invoke.asBinder(), packagesForUid[0], GActivityThread.getCallingBUid());
            }
            return invoke;
        }
    ...
    public static class getPackageForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return GreenBoxCore.getBActivityManager().getPackageForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class getUidForIntentSender extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            IInterface invoke = (IInterface) args[0];
            return GreenBoxCore.getBActivityManager().getUidForIntentSender(invoke.asBinder());
        }
    }
    ...
    public static class BroadcastIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            Intent proxyIntent = GreenBoxCore.getBActivityManager().sendBroadcast(intent, resolvedType, GActivityThread.getUserId());
            if (proxyIntent != null) {
                proxyIntent.setExtrasClassLoader(GActivityThread.getApplication().getClassLoader());
                ProxyBroadcastRecord.saveStub(proxyIntent, intent, GActivityThread.getUserId());
    ...
    public static class PeekService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            return GreenBoxCore.getBActivityManager().peekService(intent, resolvedType, GActivityThread.getUserId());
        }
    }
    ...
    public static class setServiceForeground extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            /*/if (args[0] instanceof ComponentName) {
                args[0] = new ComponentName(GreenBoxCore.getHostPkg(), ProxyManifest.getProxyService(GActivityThread.getAppPid()));
            }
            return method.invoke(who, args);*/
            return 0;
        }
