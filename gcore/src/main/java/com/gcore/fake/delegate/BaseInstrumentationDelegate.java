...
public class BaseInstrumentationDelegate extends Instrumentation {
    ...
    @Override
    public void callActivityOnPostCreate(@NonNull Activity activity, Bundle icicle) {
        mBaseInstrumentation.callActivityOnPostCreate(activity, icicle);
    }

    @Override
    public void callActivityOnPostCreate(@NonNull Activity activity, Bundle icicle, PersistableBundle persistentState) {
