...
public class BPackage implements Parcelable {
    ...
    public static final class SigningDetails implements Parcelable {
        ...
        public static final Creator<SigningDetails> CREATOR = new Creator<>() {
            @Override
    ...
    public static class IntentInfo implements Parcelable {
        ...
        public static final Creator<IntentInfo> CREATOR = new Creator<>() {
            @Override
    ...
    public static final Parcelable.Creator<BPackage> CREATOR = new Parcelable.Creator<>() {
        @Override
