...
public class TokenCache {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TokenCache that)) {
            return false;
        }
        return userId == that.userId && expiryEpochMillis == that.expiryEpochMillis && Objects.equals(account, that.account) && Objects.equals(authToken, that.authToken) && Objects.equals(authTokenType, that.authTokenType) && Objects.equals(packageName, that.packageName);
    }
