...
import com.gcore.core.system.pm.BPackage;
...
import com.gcore.proxy.ProxyBroadcastReceiver;
            ...
            for (BPackage.Activity receiver : bPackage.receivers) {
                ...
                for (BPackage.ActivityIntentInfo intent : intents) {
                    ...
                    if (BuildCompat.isOreo_MR1()) {
                        GreenBoxCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter, Context.RECEIVER_NOT_EXPORTED);
                    }
            ...
            synchronized (mReceivers) {
                ...
                if (broadcastReceivers != null) {
                    for (BroadcastReceiver broadcastReceiver : broadcastReceivers) {
                        try {
                            GreenBoxCore.getContext().unregisterReceiver(broadcastReceiver);
                        } catch (Throwable throwable) {
                            //ignore
                        }
                    }
