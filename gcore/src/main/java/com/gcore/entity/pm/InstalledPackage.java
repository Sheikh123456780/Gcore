...
public class InstalledPackage implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return GreenBoxCore.getBPackageManager().getApplicationInfo(packageName, PackageManager.GET_META_DATA, userId);
    }

    public PackageInfo getPackageInfo() {
        return GreenBoxCore.getBPackageManager().getPackageInfo(packageName, PackageManager.GET_META_DATA, userId);
    }
    ...
    public static final Parcelable.Creator<InstalledPackage> CREATOR = new Parcelable.Creator<>() {
        @Override
