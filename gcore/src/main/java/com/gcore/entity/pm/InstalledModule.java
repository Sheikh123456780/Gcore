...
public class InstalledModule implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return GreenBoxCore.getBPackageManager().getApplicationInfo(packageName, PackageManager.GET_META_DATA, BUserHandle.USER_XPOSED);
    }

    public PackageInfo getPackageInfo() {
        return GreenBoxCore.getBPackageManager().getPackageInfo(packageName, PackageManager.GET_META_DATA, BUserHandle.USER_XPOSED);
    }
    ...
    public static final Creator<InstalledModule> CREATOR = new Creator<>() {
        @Override
