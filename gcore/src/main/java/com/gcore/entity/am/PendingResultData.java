...
public class PendingResultData implements Parcelable {
    ...
    protected PendingResultData(Parcel in) {
        ...
        this.mResultExtras = in.readBundle(getClass().getClassLoader());
        this.mAbortBroadcast = in.readByte() != 0;
        this.mFinished = in.readByte() != 0;
        this.mBToken = in.readString();
    }

    public static final Parcelable.Creator<PendingResultData> CREATOR = new Parcelable.Creator<>() {
        @Override
