...
public class InstalledModule implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return VBoxCore.getBPackageManager().getApplicationInfo(packageName, FileUtils.FileMode.MODE_IWUSR, BUserHandle.USER_XPOSED);
    }

    public PackageInfo getPackageInfo() {
        return VBoxCore.getBPackageManager().getPackageInfo(packageName, FileUtils.FileMode.MODE_IWUSR, BUserHandle.USER_XPOSED);
    }
