...
public class InstalledPackage implements Parcelable {
    ...
    public ApplicationInfo getApplication() {
        return VBoxCore.getBPackageManager().getApplicationInfo(packageName, FileUtils.FileMode.MODE_IWUSR, userId);
    }

    public PackageInfo getPackageInfo() {
        return VBoxCore.getBPackageManager().getPackageInfo(packageName, FileUtils.FileMode.MODE_IWUSR, userId);
    }
