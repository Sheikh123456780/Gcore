package com.darkbox.utils.provider;
...
import com.darkbox.utils.compat.ContentProviderCompat;
...
public class ProviderCall {
	public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
		try {
			return call(authority, VBoxCore.getContext(), methodName, arg, bundle, 5);
