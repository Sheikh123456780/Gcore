...
import com.darkbox.app.RequestPermissionsActivity;
import com.darkbox.core.system.am.IRequestPermissionsResult;
...
public class PermissionUtils {
    ...
    public static boolean isCheckPermissionRequired(ApplicationInfo info) {
        if (BuildCompat.isM() || VBoxCore.getContext().getApplicationInfo().targetSdkVersion < Build.VERSION_CODES.M) {
            return false;
        }
    ...
    public static boolean checkPermissions(String[] permissions) {
        ...
        for (String permission : permissions) {
            if (!VBoxCore.get().checkSelfPermission(permission)) {
                return false;
            }
        }
        return true;
