...
import com.darkbox.utils.DrawableUtils;
...
public class TaskDescriptionCompat {
    public static ActivityManager.TaskDescription fix(ActivityManager.TaskDescription td) {
        ...
        ActivityManager am = (ActivityManager) VBoxCore.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    private static CharSequence getApplicationLabel() {
        try {
            PackageManager pm = VBoxCore.getPackageManager();
