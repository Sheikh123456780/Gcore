...
public class ContextCompat {
	...
	public static void fixAttributionSourceState(Object obj, int uid) {
		if (obj != null && BRAttributionSource.get(obj)._check_mAttributionSourceState() != null) {
			...
			attributionSourceStateContext._set_packageName(VBoxCore.getHostPkg());
	...
	public static void fix(Context context) {
		...
		try {
			...
			BRContextImpl.get(context)._set_mBasePackageName(VBoxCore.getHostPkg());
			BRContextImplKitkat.get(context)._set_mOpPackageName(VBoxCore.getHostPkg());
			BRContentResolver.get(context.getContentResolver())._set_mPackageName(VBoxCore.getHostPkg());
