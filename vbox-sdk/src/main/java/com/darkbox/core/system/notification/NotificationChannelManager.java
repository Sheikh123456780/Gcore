package com.darkbox.core.system.notification;
...
public class NotificationChannelManager {
    ...
    private void registerAppChannel() {
        NotificationManager nm = (NotificationManager) VBoxCore.getContext().getSystemService(Context.NOTIFICATION_SERVICE);
        String CHANNEL_ONE_ID = VBoxCore.getContext().getPackageName();
