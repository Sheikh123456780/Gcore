package com.darkbox.core.system.location;
...
import com.darkbox.entity.location.BCell;
import com.darkbox.entity.location.BLocation;
import com.darkbox.entity.location.BLocationConfig;
import com.darkbox.fake.frameworks.BLocationManager;
import com.darkbox.utils.CloseUtils;
    ...
    private void addTask(IBinder locationListener) {
        mThreadPool.execute(() -> {
            ...
            while (locationListener.pingBinder()) {
                ...
                VBoxCore.get().getHandler().post(() -> BRILocationListener.get(iInterface).onLocationChanged(location.convert2SystemLocation()));
            }
        });
    }
