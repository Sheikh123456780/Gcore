...
import com.darkbox.utils.HackAppUtils;
import com.darkbox.utils.Slog;
import com.darkbox.utils.compat.ActivityCompat;
...
public final class AppInstrumentation extends BaseInstrumentationDelegate implements IInjectHook {
    ...
    public void injectHook() {
        try {
            ...
            BRActivityThread.get(VBoxCore.mainThread())._set_mInstrumentation(this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
